...
Settings = home + "/.config/athena-welcome-app/settings.conf"
Skel_Settings = "/etc/skel/.config/athena-welcome-app/settings.conf"
dot_desktop = "/usr/share/applications/athena-welcome-app.desktop"
autostart = home + "/.config/autostart/athena-welcome-app.desktop"
...
def GUI(self, Gtk, GdkPixbuf):
    ...
    #button12.set_tooltip_markup("Quit the Athena Welcome App")
