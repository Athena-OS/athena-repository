...
QT_MOC_LITERAL(1, 7, 20), // "packageChoiceChanged"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 13), // "packageChoice"
QT_MOC_LITERAL(4, 43, 19), // "prettyStatusChanged"
QT_MOC_LITERAL(5, 63, 12) // "prettyStatus"

    },
    "Config\0packageChoiceChanged\0\0packageChoice\0"
    "prettyStatusChanged\0prettyStatus"
};
...
static const uint qt_meta_data_Config[] = {
 ...
 // properties: name, type, flags
       ...
       5, QMetaType::QString, 0x00495801,
...
void Config::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->packageChoiceChanged((*reinterpret_cast< QString(*)>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Config::packageChoiceChanged)) {
                *result = 0;
                return;
            }
        }
