...
variable_list = [
    ...
    ("downgrade", "Bash script to downgrade one (or multiple) packages, by using the pacman cache or the Arch Rollback Machine."),
    ("eog", "Image viewer."),
    ...
    ("htb-update", "Set, update or delete your Hack The Box App Token."),
    ...
    ("nist-feed", "NIST notifier about the newest published CVEs according your filters."),
    ...
    ("pywhat", "Identify anything. It easily lets you identify emails, IP addresses, and more. Feed it a .pcap file or some text and it'll tell you what it is!"),
    ("sl", "A steam locomotive runs across your screen. Next time write 'ls' in a good manner."),
