...
("Bug Bounty Hunter", "s3scanner", "s3scanner."),
...
("Bug Bounty Hunter", "gnu-netcat", "Command-line utility which reads and writes data across network connections, using the TCP or UDP protocols."),
...
("Enthusiast Student", "gnu-netcat", "Command-line utility which reads and writes data across network connections, using the TCP or UDP protocols."),
